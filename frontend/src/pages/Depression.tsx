      ...
      <section className="relative bg-gradient-to-br from-pink-50 via-yellow-50 to-orange-50 py-24 text-center overflow-hidden">
        ...
        <div className="relative z-10 max-w-6xl mx-auto px-6">
          ...
          <p className="max-w-3xl mx-auto text-lg text-gray-700 leading-relaxed mb-8">
            Depression is not just sadness—it's a serious mental health condition.
            Here you can learn more, find coping strategies, and take a quiz to
          ...
          <div className="grid gap-8 md:grid-cols-3">
            <div className="group bg-[#fcf9f4] rounded-3xl shadow-lg p-8 hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 border border-amber-100">
              <div className="flex items-center mb-4">
                ...
                <h3 className="font-bold text-xl text-amber-900">What is Depression?</h3>
              </div>
              <p className="text-gray-700 leading-relaxed">
                A condition that affects mood, thoughts, and overall functioning.
                Symptoms include persistent sadness, loss of interest, fatigue, and
            ...
            <div className="group bg-[#fcf9f4] rounded-3xl shadow-lg p-8 hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 border border-amber-100">
              <div className="flex items-center mb-4">
                ...
                <h3 className="font-bold text-xl text-amber-900">How Does it Happen?</h3>
              </div>
              <p className="text-gray-700 leading-relaxed">
                Depression can be triggered by genetic factors, brain chemistry,
                trauma, chronic stress, or major life events. It's not a weakness,
                but a health condition.
              </p>
            </div>
            ...
            <div className="group bg-[#fcf9f4] rounded-3xl shadow-lg p-8 hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 border border-amber-100">
              <div className="flex items-center mb-4">
                ...
                <h3 className="font-bold text-xl text-amber-900">Myths vs Facts</h3>
              </div>
              <p className="text-gray-700 leading-relaxed">
                <span className="font-semibold text-red-600">Myth:</span> Depression means being weak. <br />
                <span className="font-semibold text-green-600">Fact:</span> Depression is a medical condition that requires care and
          ...
          <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-5">
            {[
              ...
              >
                ...
                <h3 className="font-bold text-lg mb-4 text-amber-900">{item.title}</h3>
      ...
      <section className="py-20 px-6 md:px-24 text-center bg-[#f5f0e8] relative">
        ...
        <div className="relative z-10 max-w-4xl mx-auto">
          ...
          <p className="text-gray-700 max-w-2xl mx-auto mb-10 text-lg leading-relaxed">
            Answer a few simple questions to better understand your mental health.
            This is not a diagnosis but a self-reflection tool.
          </p>
      ...
      <section className="py-20 px-6 md:px-24 bg-gradient-to-br from-[#fcf9f4] via-amber-50 to-yellow-50">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            ...
            <h2 className="text-4xl font-bold mb-4 text-amber-900">What's Next?</h2>
