    ...
    <div className="bg-[#f5f0e8] min-h-screen text-gray-800">
      ...
      <section className="px-6 md:px-12 py-16 bg-[#fcf9f4] text-center">
        ...
        <p className="text-gray-700 text-base md:text-lg max-w-2xl mx-auto">
          MindEase is designed to support mental well-being by providing a safe,
          AI-powered companion you can talk to anytime, without judgment.
        </p>
      </section>
      ...
      <section className="px-6 md:px-16 py-16 space-y-10 max-w-5xl mx-auto">
        ...
        <div>
          <h2 className="text-2xl font-semibold text-amber-800 mb-3">Our Values</h2>
