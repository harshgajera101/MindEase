  ...
  return (
    <div className="bg-[#f5f0e8] min-h-screen text-gray-800">
      ...
      <section className="px-6 md:px-12 py-16 bg-[#fcf9f4] text-center">
        <h1 className="text-3xl md:text-5xl font-bold text-amber-900">Support & Help</h1>
      ...
      <section className="px-6 md:px-16 py-16 grid gap-8 md:grid-cols-2 lg:grid-cols-3 max-w-6xl mx-auto">
        <div className="bg-white rounded-xl shadow p-6 text-center">
          ...
          <a href="#faq" className="text-amber-600 hover:underline">View FAQs</a>
        </div>
        <div className="bg-white rounded-xl shadow p-6 text-center">
          ...
          <a href="mailto:support@mindease.com" className="text-amber-600 hover:underline">
            support@mindease.com
          </a>
        </div>
        <div className="bg-white rounded-xl shadow p-6 text-center">
          <h3 className="text-xl font-semibold text-amber-800 mb-2">Emergency Help</h3>
          <p className="text-gray-600 mb-4">
            If you’re in crisis, please reach out to a professional immediately.
          </p>
          <a href="tel:112" className="text-amber-600 hover:underline">Call 112</a>
        </div>
      </section>
    </div>
  );
