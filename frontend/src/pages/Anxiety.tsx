          ...
          <div className="grid gap-8 md:grid-cols-3">
            <div className="group bg-[#fcf9f4] rounded-3xl shadow-lg p-8 hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 border border-blue-100">
              ...
              <p className="text-gray-700 leading-relaxed">
                ...
                overwhelming distress, racing thoughts, and physical symptoms
                like sweating or rapid heartbeat.
              </p>
            </div>
            ...
            <div className="group bg-[#fcf9f4] rounded-3xl shadow-lg p-8 hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 border border-blue-100">
              ...
              <p className="text-gray-700 leading-relaxed">
                ...
                Anxiety means someone is weak. <br />
                <span className="font-semibold text-green-600">Fact:</span>{" "}
                Anxiety is a medical condition influenced by biology,
